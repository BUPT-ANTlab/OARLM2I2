from agent.vdn import VDNLearner
import torch
...
class QMIXNetwork(nn.Module):
    def __init__(self, input_shape, nr_agents, mixing_hidden_size=128, params=None):
        ...
        self.state_shape = int(numpy.prod(input_shape)/4)
...
class QMIXLearner(VDNLearner):
    ...
    def make_mixer_neural_network(self):
        return QMIXNetwork(self.global_input_shape, self.num_agents, params=self.params).to(self.device)
