...
parser.add_argument('--root_path', type=str, default='./data/MVP/', help='root path of the data file')
...
parser.add_argument('--train_epochs', type=int, default=5000, help='train epochs')
...
data_parser = {
    ...
    'ETTh1':{'data':'ETTh1.csv','T':'OT','M':[48,48,48],'S':[1,1,1],'MS':[7,7,1]},
